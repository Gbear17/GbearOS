> **AI_SYSTEM_INDEX**  
> **Planning** checklists and phased execution notes. **Normative behavior:** [`docs/architecture/`](../architecture/). **Roadmap index:** [`docs/ROADMAP.md`](../ROADMAP.md). **Design explorations:** [`docs/design/`](../design/).

# Todo / planning (`docs/todo/`)

Long-form phase plans and branch notes. Status is **planned** or **partial** unless the roadmap marks the corresponding work **IMPLEMENTED** in normative docs.
