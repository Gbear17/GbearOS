...
- [ ] (ID: ROAD-013) [STATUS: PLANNED] [AREA: IGC] **Phase 3 — Replay-state resilience** Decision: **3A** (silence-based replay-baseline expiry; MAC verification remains mandatory). (DOC: docs/todo/phase-03-replay-state-resilience-plan.md) (EVIDENCE: docs-only)
